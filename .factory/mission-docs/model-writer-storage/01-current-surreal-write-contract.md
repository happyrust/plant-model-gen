...
1. A Phase 1 backend is complete only when every Phase 1 row class above is either written directly or intentionally represented by an equivalent canonical projection.
