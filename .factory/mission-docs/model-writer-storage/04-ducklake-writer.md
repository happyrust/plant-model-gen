...
DuckLake Phase 1 is acceptable when CLI + SQL can compare `ducklake-canonical` raw/projection data against SurrealDB for all Phase 1 objects, including `inst_relate`, `geo_relate`, and `inst_relate_aabb`.
