...
当前三维校审 external 默认模式的事实源入口：

1. [三维校审外部流程架构说明](../架构文档/三维校审外部流程架构说明.md)
   - 适合先确认 PMS 与 Plant3D 的事实源边界、`nextStep` 原则、`return` 语义和 postMessage 时序。

2. [三维校审外部流程 PRD](../prd/三维校审外部流程PRD.md)
   - 适合产品、PMS 接入方和验收人员确认功能目标、操作流程与 AC。
