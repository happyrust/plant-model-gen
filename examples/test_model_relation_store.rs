...
use aios_database::model_relation_store::{global_store, InstRelateRecord};
...
fn main() -> anyhow::Result<()> {
    ...
    println!("   插入 {} 条，耗时 {} ms", records.len(), t.elapsed().as_millis());
    ...
    println!("   查询 {} 个 refno，返回 {} 条，耗时 {} ms",
        query_refnos.len(), inst_ids.len(), t.elapsed().as_millis());
    ...
    println!("   清理 {} 个 refno，删除 {} 条，耗时 {} ms",
        cleanup_refnos.len(), deleted, t.elapsed().as_millis());
