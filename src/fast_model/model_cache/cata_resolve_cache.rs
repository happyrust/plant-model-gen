//! [foyer-removal] 兼容缓存定义：
//! cata_resolve_cache 的结构体与全局缓存入口收敛到 model_cache。
//! 旧路径 `fast_model::foyer_cache::cata_resolve_cache` 通过 re-export 兼容。
