...
<template>
  <div class="rounded-lg border border-border bg-card/70 p-3 shadow-sm">
    <div class="flex flex-col gap-3">
      <div class="flex flex-wrap items-center gap-2">
        <span class="text-xs font-medium text-muted-foreground">快速筛选</span>
      ...
      <div class="flex flex-wrap items-center gap-3">
        <div class="relative min-w-[260px] flex-1">
          ...
          <input
            ...
            placeholder="搜索项目名称..."
            @input="emitFilter"
            class="flex h-9 w-full rounded-md border border-input bg-background pl-9 pr-3 py-1 text-sm shadow-sm placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
          />
        </div>
        <select
          v-model="statusFilter"
          @change="emitFilter"
          class="flex h-9 w-[128px] rounded-md border border-input bg-background px-3 py-1 text-sm shadow-sm focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
        >
        ...
        <div class="relative">
          ...
          <select
            v-model="riskFilter"
            @change="emitFilter"
            class="flex h-9 w-[132px] rounded-md border border-input bg-background py-1 pl-9 pr-3 text-sm shadow-sm focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
          >
